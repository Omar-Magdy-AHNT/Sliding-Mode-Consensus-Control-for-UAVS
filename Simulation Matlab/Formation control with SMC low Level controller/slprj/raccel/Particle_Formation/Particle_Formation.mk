###########################################################################
## Makefile generated for component 'Particle_Formation'. 
## 
## Makefile     : Particle_Formation.mk
## Generated on : Sun Oct 13 23:12:10 2024
## Final product: ./Particle_Formation.exe
...
PRODUCT_NAME              = Particle_Formation
MAKEFILE                  = Particle_Formation.mk
MATLAB_ROOT               = E:/Matlab
MATLAB_BIN                = E:/Matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/drone/Formation
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Particle_Formation_comp.rsp
CMD_FILE                  = Particle_Formation.rsp
...
PRODUCT = ./Particle_Formation.exe
...
DEFINES_STANDARD = -DMODEL=Particle_Formation -DNUMST=2 -DNCSTATES=9 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/Particle_Formation/Particle_Formation.c $(START_DIR)/slprj/raccel/Particle_Formation/Particle_Formation_capi.c $(START_DIR)/slprj/raccel/Particle_Formation/Particle_Formation_data.c $(START_DIR)/slprj/raccel/Particle_Formation/Particle_Formation_tgtconn.c $(START_DIR)/slprj/raccel/Particle_Formation/rtGetInf.c $(START_DIR)/slprj/raccel/Particle_Formation/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = Particle_Formation.obj Particle_Formation_capi.obj Particle_Formation_data.obj Particle_Formation_tgtconn.obj rtGetInf.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/Particle_Formation/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Particle_Formation/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Particle_Formation/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Particle_Formation/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Particle_Formation/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Particle_Formation.obj : $(START_DIR)/slprj/raccel/Particle_Formation/Particle_Formation.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Particle_Formation_capi.obj : $(START_DIR)/slprj/raccel/Particle_Formation/Particle_Formation_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Particle_Formation_data.obj : $(START_DIR)/slprj/raccel/Particle_Formation/Particle_Formation_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Particle_Formation_tgtconn.obj : $(START_DIR)/slprj/raccel/Particle_Formation/Particle_Formation_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/Particle_Formation/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/Particle_Formation/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
